 ...
 *   verkoop een vermenigvuldigingsfactor (dubbele-puntenacties), dus dat getal
 *   is niet vast.
 * - Blijven herhalen. Er gaat één mail per spaarronde uit. Pas als iemand zijn
 *   punten heeft ingewisseld en opnieuw de band in groeit, mag het weer.
 */
